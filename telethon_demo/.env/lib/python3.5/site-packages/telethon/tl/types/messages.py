...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDialog, TypeChatFull, TypeStickerPack, TypeFoundGif, TypeInlineBotSwitchPM, TypeBotInlineResult, TypeStickerSet, TypeDocument, TypeMessage, TypeStickerSetCovered, TypeHighScore, TypeEncryptedFile, TypeChat, TypeUser
