...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypeContactLink, TypePopularContact, TypePeer, TypeImportedContact, TypeTopPeerCategoryPeers, TypeChat, TypeContact, TypeUser
