...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureValueHash, TypeInputNotifyPeer, TypeReportReason, TypeSecureCredentialsEncrypted, TypeBool, TypeInputPeerNotifySettings, TypeInputPrivacyRule, TypeInputPeer, TypeInputPrivacyKey, TypeInputSecureValue, TypeAccountDaysTTL, TypeSecureValueType
