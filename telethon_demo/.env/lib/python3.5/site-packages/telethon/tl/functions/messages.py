...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputEncryptedChat, TypeInputMedia, TypeReportReason, TypeSendMessageAction, TypeInputEncryptedFile, TypeInputGeoPoint, TypeInputUser, TypeInputDialogPeer, TypeInputStickerSet, TypeInlineBotSwitchPM, TypeMessagesFilter, TypeInputStickeredMedia, TypeInputDocument, TypeInputBotInlineMessageID, TypeInputSingleMedia, TypeShippingOption, TypeInputChatPhoto, TypeBool, TypeInputBotInlineResult, TypeInputMessage, TypeInputPeer, TypeMessageEntity, TypeReplyMarkup
