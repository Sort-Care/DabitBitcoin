...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeInputMessage, TypeChannelBannedRights, TypeChannelAdminLogEventsFilter, TypeChannelAdminRights, TypeInputChatPhoto, TypeChannelParticipantsFilter, TypeInputUser, TypeInputChannel, TypeBool
