...
Answer: I think it is totally possible, but requires a lot of work to do so. Coding such a service requires a fully and robust understanding of not only Bitcoins but also cryptology and other information security stuff. I think such a task usually requires a team.
